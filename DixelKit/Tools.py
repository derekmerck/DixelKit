...
class DixelTools(object):
        ...
        if csv_file:
            with open(csv_file, 'rU') as f:
                ...
                for item in items:
                    ...
                    d = Dixel(id, level=DicomLevel.STUDY, meta=item)
                    s.add(d)
    ...
    @classmethod
    def orthanc_id(cls, PatientID, StudyInstanceUID, SeriesInstanceUID=None, SOPInstanceUID=None):
